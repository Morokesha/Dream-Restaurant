...
{
    [SerializeField] private Texture2D lastScreenshot;

    [SerializeField] public GameObject currentGameObject;

    [SerializeField] public RawImage testImage;

    [SerializeField] public bool isMultipleObject;

    [SerializeField] public string ScreenShotPath;
    ...
    public void TakeScreenShot()
    {
        ...
        var screenShotCam = newObj.AddComponent<Camera>();
        ...
        for (var t = 0; t < transform.childCount; t++) transform.GetChild(t).gameObject.SetActive(false);
    ...
    public void TakeSingleScreenShot(Camera screenShotCam)
    {
        ...
        var sqr = 512;
        var virtualPhoto = new Texture2D(sqr, sqr, TextureFormat.RGB24, false);
        ...
        try
        {
            ...
            var fPath = dir + currentGameObject.name + ".png";
    ...
    public Texture2D PositionCamAndGetScreenTexture(Camera screenShotCam, int sqr = 50)
    {
        ...
        var objBounds = currentGameObject.transform.EncapsulateBounds().extents;
        ...
        var posVector = new Vector3(0f, -.1f, -.1f) * (maxZoomIn + maxZoomOut);

        var cameraRot = Quaternion.Euler(45f, -180f, 0f);
        ...
        var tempRT = new RenderTexture(sqr, sqr, 24);
