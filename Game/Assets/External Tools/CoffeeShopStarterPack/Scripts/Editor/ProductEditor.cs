...
namespace PW
{
    ...
    {
        private SerializedProperty addToPlateBeforeServed;

        private SerializedProperty dontIncludeInThisScene;

        private SerializedProperty orderID;

        private SerializedProperty orderPrice;

        private SerializedProperty plateOffset;

        private SerializedProperty productType;
        private SerializedProperty propName;

        private SerializedProperty regenerateProduct;

        private SerializedProperty servedAsDifferentGameObject;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (GUILayout.Button("Remove Product \n X "))
            {
                ...
                var result = pm.RemoveProduct(orderID.intValue);
                if (result) Undo.RegisterCompleteObjectUndo(pm, "Delete Product " + orderID);
            }
            ...
            plateOffset.vector3Value = EditorGUILayout.Vector3Field("plateOffset",
                plateOffset != null ? plateOffset.vector3Value : Vector3.zero);
            ...
            regenerateProduct.boolValue = EditorGUILayout.Toggle("RegenerateProduct",
                regenerateProduct != null ? regenerateProduct.boolValue : false);
