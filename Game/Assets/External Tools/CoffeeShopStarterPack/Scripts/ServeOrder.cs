...
namespace PW
{
    public class ServeOrder : MonoBehaviour
    {
        ...
        private float curServeTime; //How much time left

        private Image m_Image; //Image to hold product sprite.

        private readonly int order_count = 1;

        //for demo we only check for one product
        //by order but you can add more products for a serving.
        private int total_order_served;

        private float totalServingTime; //Total serving time for order
        ...
        public void Update()
        {
            ...
            if (serveTimeRepresentation != null) serveTimeRepresentation.fillAmount = curServeTime / totalServingTime;
        }
        ...
        public void ServeMe()
        {
            ...
            if (PlayerSlots != null)
            {
                ...
                if (!PlayerSlots.HoldsItem(orderID)) return;
        ...
        public void OrderCompleted()
        {
            ...
            var success = curServeTime / totalServingTime;
