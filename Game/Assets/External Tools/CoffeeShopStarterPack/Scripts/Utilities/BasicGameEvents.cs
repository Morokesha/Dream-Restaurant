...
namespace PW
{
    public class BasicGameEvents : MonoBehaviour
    {
        ...
        {
            if (onProductAddedToSlot != null) onProductAddedToSlot.Invoke(ID);
        }
        ...
        {
            if (onProductDeletedFromSlot != null) onProductDeletedFromSlot.Invoke(ID);
        }
        ...
        {
            if (onOrderCancelled != null) onOrderCancelled.Invoke(ID);
        }
        ...
        {
            if (onOrderCompleted != null) onOrderCompleted.Invoke(ID, percentageSuccess);
        }
