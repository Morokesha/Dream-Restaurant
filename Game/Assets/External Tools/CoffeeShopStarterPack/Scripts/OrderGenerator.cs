...
namespace PW
{
    public class OrderGenerator : MonoBehaviour
    {
        ...
        [HideInInspector] public int[] orderedProducts;
        ...
        public void GenerateOrder()
        {
            ...
            var spriteIndex = Random.Range(0, orderSprites.Length);

            var orderID = orderedProducts[spriteIndex];

            var newOrder = Instantiate(orderRepPrefab, UIParentForOrders).GetComponent<ServeOrder>();
